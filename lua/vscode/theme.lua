...
theme.load_syntax = function()
    ...
    local syntax = {
        ...
        Keyword = { c.vscPink, nil, 'italic', nil },
        ...
        TSFunction = { c.vscYellow, nil, 'italic', nil },
        ...
        TSKeyword = { c.vscBlue, nil, 'italic', nil },
        TSKeywordFunction = { c.vscBlue, nil, 'italic', nil },
        TSKeywordOperator = { c.vscBlue, nil, 'italic', nil },
